    ...
    while (contador_a_saida == 1) {
        ...
        switch (escolha) {
            ...
            case 'b':
                ...
                for (contador = 0; contador <= 1; contador++) {
                    printf("\nO cientista %s nascido em %d tem atualmente %d anos.", nome_cientista[contador],
                           ano_cientistas[contador], ano_atual - ano_cientistas[contador]);
                }
            ...
            case 'h':
                ...
                for (contador = 0; contador <= 24; contador++) {
                    ...
                    for (contador2 = 0; contador2 <= 2; contador2++) {
                        printf("Entre com as notas do estudante %s, %d° Nota: ", nome_estudante_notas[contador],
                               contador2 + 1);
            ...
            case 'k':
                ...
                for (contador = 0; contador <= 19; contador++) {
                    printf("\nO(a) %s nasceu em %d, idade atual em %d: %d", nome_pessoa_j[contador],
                           ano_pessoa[contador], ano_atual_j, ano_atual_j - ano_pessoa[contador]);
                }
            ...
            case 'n':
                ...
                for (contador = 0; contador <= 4; contador++) {
                    ...
                    printf("Entre com o tempo (Segundos) que demorou para %.2f litros acabar: ",
                           litros_vazao[contador]);
                ...
                for (contador = 0; contador <= 4; contador++) {
                    printf("\nO(a) %s com %.2f demorou %.2f segundos e teve umas vazão de %f", liquido[contador],
                           litros_vazao[contador], segundos_vazao[contador], vazao[contador]);
                }
            ...
            case 'o':
                ...
                printf("\nOs gases foram:\n");
                for (contador = 0; contador <= 19; contador++) {
                    printf("\nO gas: %s tem o volume %f e Pressao %f", gases[contador], volume[contador],
                           pressao[contador]);
                }
